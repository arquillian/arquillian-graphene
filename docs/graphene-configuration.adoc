...
https://raw.githubusercontent.com/arquillian/arquillian-extension-drone/gh-pages/docs/configuring-drone-instances.adoc[arquillian.xml
...
//TODO Check Updated Link
Refer to 
https://raw.githubusercontent.com/arquillian/arquillian-extension-drone/gh-pages/docs/configuring-drone-instances.adoc[Selenium
