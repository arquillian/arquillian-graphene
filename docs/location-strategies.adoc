...
The reason behind it is that particular web drivers must implement the method `getDomAttribute()`, which was added to the constructor of the `Select` element since Selenium 4. See the Selenium issues https://github.com/SeleniumHQ/selenium/issues/9895[#9895], https://github.com/SeleniumHQ/selenium/issues/9381[#9381].
