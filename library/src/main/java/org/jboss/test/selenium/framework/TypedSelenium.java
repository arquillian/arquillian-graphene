...
public interface TypedSelenium {
	 ...
	 */
	List<String> getAttributeFromAllWindows(String attributeName);
	 ...
	 *            be made.
	 */
	void useXpathLibrary(XpathLibrary libraryName);
	 ...
	 */
	BufferedImage captureScreenshotToString();
	 ...
	 */
	BufferedImage captureEntirePageScreenshotToString(Kwargs kwargs);
