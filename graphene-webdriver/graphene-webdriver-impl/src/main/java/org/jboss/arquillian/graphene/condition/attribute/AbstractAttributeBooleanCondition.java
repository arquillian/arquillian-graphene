...
public abstract class AbstractAttributeBooleanCondition extends AbstractElementBooleanCondition {
    ...
    public AbstractAttributeBooleanCondition(WebElement element, String attribute) {
        this(element, attribute, false);
    }

    public AbstractAttributeBooleanCondition(WebElement element, String attribute, boolean negation) {
