...
public class AttributeValueEquals extends AbstractAttributeAndValueBooleanCondition {
    ...
    public AttributeValueEquals(WebElement element, String attribute, String value) {
        super(element, attribute, value);
    }

    public AttributeValueEquals(WebElement element, String attribute, String value, boolean negation) {
    ...
    protected Boolean check(WebDriver driver) {
        ...
        return found != null && found.equals(getValue());
    }
