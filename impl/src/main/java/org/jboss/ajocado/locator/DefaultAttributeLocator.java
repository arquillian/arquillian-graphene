...
public class DefaultAttributeLocator<E extends ElementLocator<E>> extends AbstractLocator<AttributeLocator<E>>
     ...
     * (non-Javadoc)
     * 
     * @see org.jboss.ajocado.locator.Locator#getRawLocator()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jboss.ajocado.locator.AttributeLocator#getLocationStrategy()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jboss.ajocado.locator.AttributeLocator#getAssociatedElement()
     */
