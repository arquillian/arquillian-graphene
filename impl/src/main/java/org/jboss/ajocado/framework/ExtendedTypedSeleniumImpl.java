...
import org.jboss.ajocado.css.CssProperty;
import org.jboss.ajocado.geometry.Point;
...
public class ExtendedTypedSeleniumImpl extends TypedSeleniumImpl implements ExtendedTypedSelenium {
     ...
     * (non-Javadoc)
     * 
     * @see org.jboss.ajocado.framework.ExtendedTypedSelenium#isStarted()
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jboss.ajocado.framework.TypedSeleniumImpl#start()
     */
    public void start() {
     ...
     * (non-Javadoc)
     * 
     * @see org.jboss.ajocado.framework.TypedSeleniumImpl#stop()
     */
    public void stop() {
        super.stop();
        started = false;
     ...
     * (non-Javadoc)
     * 
     * @see org.jboss.ajocado.framework.ExtendedTypedSelenium#enableNetworkTrafficCapturing(boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see org.jboss.ajocado.framework.ExtendedTypedSelenium#isNetworkTrafficCapturingEnabled()
     */
     ...
     * 
     * @see
     * org.jboss.ajocado.framework.ExtendedTypedSelenium#getStyle(org.jboss.test.selenium.locator.ElementLocator,
     * java.lang.String)
     */
     ...
     * @see
     * org.jboss.ajocado.framework.ExtendedTypedSelenium#getStyle(org.jboss.test.selenium.locator.ElementLocator,
     * org.jboss.ajocado.css.CssProperty)
     */
     ...
     * (non-Javadoc)
     * 
     * @see ExtendedTypedSelenium#scrollIntoView(org.jboss.ajocado.locator.ElementLocator , boolean)
     */
     ...
     * (non-Javadoc)
     * 
     * @see ExtendedTypedSelenium#mouseOverAt(org.jboss.ajocado.locator.ElementLocator ,
     * org.jboss.ajocado.geometry.Point)
     */
     ...
     * (non-Javadoc)
     * 
     * @see ExtendedTypedSelenium#isDisplayed(org.jboss.ajocado.locator.ElementLocator )
     */
     ...
     * (non-Javadoc)
     * 
     * @see ExtendedTypedSelenium#belongsClass(org.jboss.ajocado.locator.ElementLocator , java.lang.String)
     */
     ...
     * (non-Javadoc)
     * 
     * @see ExtendedTypedSelenium#isAttributePresent(org.jboss.ajocado.locator. AttributeLocator)
     */
     ...
     * (non-Javadoc)
     * 
     * @see DefaultTypedSelenium#getCount(org.jboss.ajocado.locator.IterableLocator)
     */
    @Override
     ...
     * 
     * @see
     * org.jboss.ajocado.framework.ExtendedTypedSelenium#check(org.jboss.test.selenium.locator.ElementLocator,
     * boolean)
     */
    @Override
