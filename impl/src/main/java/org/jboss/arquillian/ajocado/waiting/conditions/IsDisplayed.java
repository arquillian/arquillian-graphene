 ...
 * @version $Revision$
 */
public class IsDisplayed implements SeleniumCondition, JavaScriptCondition {
    ...
    public JavaScript getJavaScriptCondition() {
        ...
        return js("selenium.isDisplayed('{0}')").parametrize(escapedLocator);
    }
