...
public abstract class AbstractElementAndTextBooleanCondition extends AbstractElementBooleanCondition {
    ...
    public AbstractElementAndTextBooleanCondition(WebElement element, String text) {
        this(element, text, false);
    }

    public AbstractElementAndTextBooleanCondition(WebElement element, String text, boolean negation) {
