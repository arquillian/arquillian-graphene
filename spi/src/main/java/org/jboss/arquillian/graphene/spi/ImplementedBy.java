...
/**
 * Denotes implementation for annotated interface or abstract class so that it can be instantiated via {@link TypeResolver}.
 *
 * @author Lukas Fryc
 */
@Target({ TYPE })
...
public @interface ImplementedBy {
     ...
     */
    Class<?> value() default ImplementedBy.class;
